...
public class MarkdownController {
    ...
    public byte[] makeMDzipFile(@RequestBody List<Map<String, Object>> readme) throws IOException { // 받을 인자: md파일 명,
        ...
        builder.command("cmd.exe","/c","mkdir","/Q", "mdFiles"); // window
        builder.start();
        ...
        builder.command("cmd.exe", "/c", "zip","/Q", "mdZipFiles.zip", "-r", "./mdFiles"); // window
        ...
        /* window*/
        builder.command("cmd.exe","/c","rmdir","/S","/Q", "./mdFiles");
        builder.start();
